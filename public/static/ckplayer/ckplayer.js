  ...
  return {
    ...
    style: { //风格部分内容配置，这里主要配置loading和logo以及广告的部分内容
      ...
      advertisement: { //广告相关的配置
        ...
        closeButtonShow: false,//暂停时是否显示关闭广告按钮
        closeOtherButtonShow: false,//其它广告是否需要关闭广告按钮
  ...
  ckplayer.prototype = {
    ...
    embedSWF: function () {
      ...
      if (!this.checkShockwaveFlash()) {
        this.PD.innerHTML = '<div style=" width: 400px;position: absolute; top: 35%;left: 50%; margin-left: -200px;;"><p>' + this.language['noLoadShockwaveFlash'] + '</p><div style="margin-top: 20px;    margin-top: 20px;display: flex;justify-content: space-around;"><p style="padding: 10px 20px;border-radius: 15px;background:#1890ff;"><a href="http://www.adobe.com/go/getflashplayer" rel="nofollow" target="_blank" style="color:#fff">' + this.language['downLoadShockwaveFlash'] + '</a></p><p style="padding: 10px 20px;border-radius: 15px;background: #ccc;"><a style="color: #000;" href="../../../static/exe/install_flash_player_ppapi.exe" download="install_flash_player_ppapi.exe">点击下载</a></p></div></div>';
